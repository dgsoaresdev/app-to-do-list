...
<!-- Theme Settings -->
        ...
        @if( $page_slug === 'tarefas' )
          ...
          <!-- Daterangepicker Plugin js -->
            ...
            {{-- LEFT --}}
                <div v class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasExampleLabel">Carregando...</h5>
                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div> <!-- end offcanvas-header-->

                    <div class="offcanvas-body">
                        <div class="ContainerSpinner d-flex justify-content-center align-items-center h-100 col-12">
            ...
            {{-- RIGHT --}}
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                    <div class="offcanvas-header">
                        <h5 id="offcanvasRightLabel">Carregando...</h5>
                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div> <!-- end offcanvas-header-->
    ...
    {{-- <script src="{{ asset('test/toastr.min.js') }}"></script> --}}
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    //setInterval(function () {
                        $(ContentID+' .offcanvas-header h5').text(ContentTitle);
                        $(ContentID+' .offcanvas-body').html(response);
